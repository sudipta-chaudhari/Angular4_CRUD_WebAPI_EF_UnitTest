...
var InventoryService = (function () {
    ...
    InventoryService.prototype.addProduct = function (product) {
        ...
        return this.http.post('/api/Product/AddProduct', body, options).map(function (res) { return res.json(); });
    };
    InventoryService.prototype.updateProduct = function (product) {
        ...
        return this.http.post('/api/Product/UpdateProduct', body, options).map(function (res) { return res.json(); });
    };
